...
<main>
  ...
  <div class="comentarios-section" style="max-width: auto; margin: 0 30px;">
    ...
    LilCMS, es un gestor de contingut que estic creant amb django (edit: Será un Headless CMS). Es different a php, pero em dona una idea general de com fer-ho.
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
      <div class="formul" style="margin-bottom: 20px;">
        <form method="POST" action="index.php">
          ...
          <div class="formGroup" style="margin-top: 10px; margin-bottom: 15px;">
            <input type="url" name="gif_url" placeholder="Enganxa un enllaç a un GIF (opcional)..." style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ccc;">
          </div>
    ...
    <div class="lista-comentarios">
      ...
      <?php else: ?>
        <?php foreach ($comentarios as $c): ?>
          <?php
          $esDuenyo = (isset($_SESSION['user_id']) && $_SESSION['user_id'] == $c['user_id']);
          ...
          <div class="comentario" style="display: flex; gap: 15px; background: #fff; padding: 15px; border-radius: 8px; border: 1px solid #eee; margin-bottom: 10px;">
            ...
            <div style="flex-grow: 1;">
              <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                ...
                <?php if ($esDuenyo): ?>
                  <div style="display:block;">
                    ...
                    <form method="POST" action="editarC.php" style="display:inline-block;">
                      <div title="Edita aquest comentari">
                        <input type="hidden" name="id_a_editar" value="<?= $c['id'] ?>">
                        <button class="afegirBtn"><img src="/assets/imatges/botons/edit.svg" alt=""> Editar comentari</button>
                      </div>
                    </form>
                  </div>
                <?php endif; ?>
              ...
              <?php if (!empty($c['gif_url'])): ?>
                <div style="margin-top: 10px;">
                  <img src="<?= htmlspecialchars($c['gif_url'], ENT_QUOTES, 'UTF-8') ?>" alt="GIF adjunt" style="max-width: 100%; border-radius: 8px;">
                </div>
              <?php endif; ?>
            </div>
          </div>
